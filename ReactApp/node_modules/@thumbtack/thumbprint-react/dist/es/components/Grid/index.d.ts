...
export declare function GridColumn({ children, base, aboveSmall, aboveMedium, aboveLarge, dataTestId, dataTest, }: GridColumnProps): JSX.Element;
...
export declare function Grid({ children, gutter, dataTestId, dataTest, }: GridProps): JSX.Element;
