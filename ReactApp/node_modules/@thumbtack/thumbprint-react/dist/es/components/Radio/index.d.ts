...
export default function Radio({ children, dataTest, id, isChecked, isDisabled, isRequired, hasError, labelPadding, name, onChange, radioVerticalAlign, }: RadioProps): JSX.Element;
