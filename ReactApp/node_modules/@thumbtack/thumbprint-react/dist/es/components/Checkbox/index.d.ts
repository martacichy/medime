...
export default function Checkbox({ checkboxVerticalAlign, children, dataTest, dataTestId, hasError, id, isChecked, isDisabled, isIndeterminate, labelPadding, isRequired, name, onChange, value, }: CheckboxProps): JSX.Element;
