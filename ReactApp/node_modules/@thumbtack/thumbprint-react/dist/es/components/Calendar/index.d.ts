...
export declare function normaliseValue(value: CalendarProps['value']): Date[];
...
export declare function validateProps(props: CalendarProps): void;
 ...
 */
declare const Calendar: ({ value, onChange, onMonthChange, disabledDays, month, lastMonth, allowMultiSelection, daysThemeDotIndicator, daysThemeStrikeout, }: CalendarProps) => JSX.Element;
