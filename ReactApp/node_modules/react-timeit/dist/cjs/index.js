...
function createWithTheme(context) {
  return function hoc(Component) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      withTheme.displayName = "WithTheme(" + _default(Component) + ")";
    }
...
const TimeColumn = ({ start, end, setValue, value, exclude, notShowExclude }) => {
    ...
    const [slecetorMove, setSlecetorMove] = React.useState(+value ? +value : 0);
    const timeArray = [];
    for (let time = start; time <= end; time++) {
        if (notShowExclude)
            !(exclude === null || exclude === void 0 ? void 0 : exclude.includes(time)) && timeArray.push(time);
        else
            timeArray.push(time);
    }
    React.useEffect(() => {
        let prev = slecetorMove;
        if (exclude === null || exclude === void 0 ? void 0 : exclude.includes(prev)) {
            while (exclude === null || exclude === void 0 ? void 0 : exclude.includes(prev)) {
                prev = prev + 1;
    ...
    const controlBottom = () => {
        let prev = slecetorMove;
        if (prev !== end) {
            if (exclude === null || exclude === void 0 ? void 0 : exclude.includes(prev + 1)) {
                while (exclude === null || exclude === void 0 ? void 0 : exclude.includes(prev + 1)) {
                    if (prev + 2 > end) {
    ...
    const controlTop = () => {
        ...
        if (prev !== start) {
            ...
            let endnumber = end;
            if (exclude === null || exclude === void 0 ? void 0 : exclude.includes(end)) {
                while (exclude === null || exclude === void 0 ? void 0 : exclude.includes(endnumber - 1)) {
    ...
    return (jsxRuntime.exports.jsxs("div", Object.assign({ className: classes.control }, { children: [jsxRuntime.exports.jsx("div", Object.assign({ className: classes.control__time, onClick: controlTop }, { children: jsxRuntime.exports.jsx("svg", Object.assign({ width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.exports.jsx("path", { d: "M19.9201 15.0499L13.4001 8.52989C12.6301 7.75989 11.3701 7.75989 10.6001 8.52989L4.08008 15.0499", strokeWidth: "2", strokeMiterlimit: "10", strokeLinecap: "round", strokeLinejoin: "round", className: classes.control__svg }, void 0) }), void 0) }), void 0), jsxRuntime.exports.jsxs("div", Object.assign({ className: classes.wrapper }, { children: [jsxRuntime.exports.jsx("div", { className: classes.selector }, void 0), jsxRuntime.exports.jsx("div", Object.assign({ className: classes.timeWrapper, style: {
                            transform: `translateY(-${slecetorMove && timeArray.indexOf(slecetorMove) * 40}px)`,
                        } }, { children: timeArray.map((time) => (jsxRuntime.exports.jsx("div", Object.assign({ className: `${classes.time} ${+time === slecetorMove ? classes.selected : ""} ${exclude && exclude.includes(+time) ? classes.disabled : ""}` }, { children: time.toString().length === 1 ? `0${time}` : time }), time))) }), void 0)] }), void 0), jsxRuntime.exports.jsx("div", Object.assign({ className: classes.control__time, onClick: controlBottom }, { children: jsxRuntime.exports.jsx("svg", Object.assign({ width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.exports.jsx("path", { d: "M19.9201 8.94995L13.4001 15.47C12.6301 16.24 11.3701 16.24 10.6001 15.47L4.08008 8.94995", strokeWidth: "2", strokeMiterlimit: "10", strokeLinecap: "round", strokeLinejoin: "round", className: classes.control__svg }, void 0) }), void 0) }), void 0)] }), void 0));
};
...
const Timeit = ({ onChange, defualtValue, minuteExclude, hourExclude, notShowExclude, }) => {
    ...
    return (jsxRuntime.exports.jsxs("div", Object.assign({ className: classes.wrapper }, { children: [jsxRuntime.exports.jsx(TimeColumn, { notShowExclude: notShowExclude, start: 0, end: 23, value: hour, setValue: setHour, exclude: hourExclude }, void 0), jsxRuntime.exports.jsx(TimeColumn, { notShowExclude: notShowExclude, start: 0, end: 59, value: minute, setValue: setMinute, exclude: minuteExclude }, void 0)] }), void 0));
};
